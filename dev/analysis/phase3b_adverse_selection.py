    ...
    def get_summary(self):
        ...
        for bucket_info in PRICE_BUCKETS:
            ...
            if bs['unconditional_total'] >= 20 and bs['conditional_fills'] >= 10:
                uncond_wr = bs['unconditional_wins'] / bs['unconditional_total']
                cond_wr = bs['conditional_wins'] / bs['conditional_fills']
                ...
                summary['bucket_analysis'][label] = {
                    ...
                    'fill_rate': bs['conditional_fills'] / bs['unconditional_total'],
                    'n_unconditional': bs['unconditional_total'],
                    'n_conditional': bs['conditional_fills'],
                }
